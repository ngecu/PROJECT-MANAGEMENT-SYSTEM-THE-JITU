...
import { createProject, deleteProject, getAllProjects, getMyProjects, getProject, updateProject } from "../controllers/projectControlles";

const project_router = Router();

project_router.get("/allProjects", getAllProjects);
project_router.get('/:project_id', getProject);
project_router.post('/addProject',createProject );
